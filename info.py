...
auth_channel = environ.get('AUTH_CHANNEL', '-1002992786655')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002992786655').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002992786655').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/bot_verify_video/12')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/bot_verify_video/12')  # Tutorial video link for opening shortlink website
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TheAllCollection')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/MovieCleepsHelp_bot')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/TheAllCollection')
